...
const styles = StyleSheet.create({
  ...
  header: { 
    flexDirection: 'row', // Changed to row to align back button, title, and reports button
    padding: 20, 
    borderBottomWidth: 1, 
  ...
  reportsButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#e74c3c', padding: 10, borderRadius: 8 },
  reportsButtonText: { color: '#FFF', fontSize: 16, marginLeft: 5 },
